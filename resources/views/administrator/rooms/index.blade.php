<x-layout>
    ...
    <x-containers.main>
        <x-content-header>RMCI Classes</x-content-header>
        ...
        @if ($rooms->count() === 0)
            <div>
                <p class="text-gray-500 flex items-center space-x-3">
                    ...
                    <span>There are no rooms available yet.</span>
                </p>
            </div>
        @else
                                ...
                                @foreach ($rooms as $room)
                                    ...
                                    <tr x-data="{ show: false }">
                                                ...
                                                <div class="ml-4">
                                                    <div class="text-xs font-primary font-medium text-blue-900">
                                                        <div class="flex items-center space-x-3">
                                                            <a href="{{ route('admin.schedules.create', $room->id) }}" title="Add Schedule">
                                                                <x-icons.add class="w-6 h-6 text-green-600"></x-icons.add>
                                                            </a>
                                                            <a href="{{ route('admin.schedules.index', $room->id) }}" title="View Schedules">
                                                                <x-icons.view class="w-6 h-6 text-blue-600"></x-icons.view>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex items-center">
                                                <x-forms.edit-button href="{{ route('admin.rooms.edit', $room->id) }}?strand={{ $room->strand->name }}&grade={{ $room->grade->name }}">
                                                </x-forms.edit-button>
                                                <div @click="show = true">
