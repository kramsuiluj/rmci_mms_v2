        ...
        @if ($room->schedules->count() === 0)
            <div>
                <p class="text-gray-500 flex items-center space-x-3">
                    ...
                    <span>There are no schedules available yet.</span>
                </p>
            </div>
        @else
                                ...
                                @foreach ($room->schedules as $schedule)
                                    ...
                                    <tr x-data="{ show: false }">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex items-center">
                                                <x-forms.edit-button href="{{ route('admin.schedules.edit', [$room->id, $schedule->id]) }}">
                                                </x-forms.edit-button>
                                                <div @click="show = true">
                                        ...
                                        <td
                                            ...
                                            style="display: none"
                                        >
                                            <form action="{{ route('admin.schedules.destroy', [$room->id, $schedule->id]) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
