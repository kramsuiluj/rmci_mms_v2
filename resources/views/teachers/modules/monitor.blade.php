<x-layout>
    ...
    <x-containers.main>
        ...
        <div x-data="{ open: false }">
            <button
                class="rounded-md border border-gray-300 bg-gray-100 text-blue-900 font-semibold px-5 py-1 flex items-center space-x-10"
                @click="open = !open"
            >
            ...
            <div
                class="border border-gray-300 mt-1 rounded-md bg-gray-100 w-96"
                x-show="open"
