        ...
        <div class="flex items-center justify-between">
            ...
            <div class="cursor-pointer text-blue-900" x-data="{ isOpen: false }">
                <div class="hover:text-blue-600 flex items-center" @click="isOpen = !isOpen">
                    <h4 class="text-xs sm:text-sm font-medium">{{ auth()->user()->firstname ?? null }}</h4>
                    <div>
                ...
                <div
                    class="absolute text-sm bg-gray-50 w-28 -ml-4 sm:-ml-1 mt-1 rounded-l-md rounded-br-md border border-gray-300 shadow"
                    x-show="isOpen"
...
{{--                        >--}}
{{--                            <a href="" class="text-xs sm:text-sm">Notification</a>--}}
{{--                        </div>--}}
