            ...
            <div class="flex items-center space-x-2 sm:space-x-10">
                ...
                <a href="{{ route('student.index') }}">
                    <div class="flex items-center cursor-pointer">
                        ...
                        <h3 class="text-blue-900 font-black sm:text-xl hover:text-blue-600">
                            RMCI
            ...
            <div class="cursor-pointer text-blue-900" x-data="{ isOpen: false }">
                <div class="hover:text-blue-600 flex items-center" @click="isOpen = !isOpen">
                    <h4 class="text-xs sm:text-sm font-medium flex">
                        <span>{{ auth()->user()->firstname ?? null }}</span>
                        @if (auth()->user()->profile->unreadNotifications->count() !== 0)
                ...
                >
                    <div class="">
                        ...
                        >
                            <a href="{{ route('student.notifications.index') }}" class="text-xs sm:text-sm">Notification</a>
                        </div>
